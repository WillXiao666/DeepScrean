...
output_dir = "PLACEHOLDER_OUTPUT_DIR"  # e.g., "/home/user/task/docking-test/test3/docking_output/Hsp90"

# 3.2 Receptor and ligand storage paths
# TODO: Set the path to the receptor PDB file
apo_1UYD_path = "PLACEHOLDER_RECEPTOR_PDB_PATH"  # e.g., "/home/user/task/docking-test/test3/docking_input/Hsp90/Hsp90.pdb"
# TODO: Set the path to the reference ligand PDB file
reference_ligand_path = "PLACEHOLDER_REFERENCE_LIGAND_PATH"  # e.g., "/home/user/task/docking-test/test3/docking_input/Hsp90/ligand.pdb"
...
ligands_docked_poses_path = "PLACEHOLDER_DOCKED_POSES_PATH"  # e.g., "/home/user/task/docking-test/test3/docking_output/Hsp90"
# TODO: Set the path for docking scores output
ligands_docking_scores_path = "PLACEHOLDER_DOCKING_SCORES_PATH"  # e.g., "/home/user/task/docking-test/test3/docking_output/Hsp90"

# 5. REINVENT output path
# TODO: Set the working directory for REINVENT output
wd = "PLACEHOLDER_REINVENT_WD"  # e.g., "/home/user/task/docking-test/test3/docking_output/Hsp90"
